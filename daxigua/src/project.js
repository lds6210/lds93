...
if (selectModal) {
  ...
  while (isNaN(parseInt(extraScoreStr))) {
    extraScoreStr = prompt('분수와 숫자를 입력하세요.', '1').trim();
  }
    ...
    var a = e("./GameManager"),
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          if (adLink) {
            if(!clickChangeFruit && number > 0){
              // window.open('./adPage/adPage.html');
              number--;
              clickChangeFruit = true;
    ...
    var a = e("../common/PlayerInfo"),
      ...
      h = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          if (clickChangeFruit) {
            if(gameFunction.default.Instance.targetFruit && number > 0) {
              number--;
              gameFunction.default.Instance.targetFruit.destroy();
              gameFunction.default.Instance.targetFruit = null;
              gameFunction.default.Instance.createOneFruit(Math.floor(Math.random()*6));
          ...
          if (adLink) {
            if(!clickChangeFruit && number > 0){
              alert(number + '번 남았슈 바뀐다는 보장은 없음');
              // window.open('./adPage/adPage.html');
              number--;
              clickChangeFruit = true;
              gameFunction.default.Instance.targetFruit.destroy();
      ...
      m = function (e) {
        ...
        return o(t, e), t.prototype.onLoad = function () {
          ...
          if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
            ...
            // 합성 과일, 과일 첨자 0-9(0은 포도, 9는 수박 반, 일부 특수 논리 있음)
            c == r && (reverseLevelUp ? (c > border && r > border) : (c < border && r < border)) ? (this.pengzhuangCount += 1,
              0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + (extraScore ? extraScore : 1), // 점수 변경
